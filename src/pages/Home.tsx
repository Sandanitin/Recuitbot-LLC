        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[1, 2, 3].map((testimonial) => (
              <div key={testimonial} className="bg-gray-50 rounded-xl p-8">
                ...
                <p className="text-gray-600 mb-4 italic">
                  "Recuitbot has been instrumental in helping us find the right talent for our development projects. Their expertise and attention to detail are unmatched."
                </p>
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900">Client {testimonial}</p>
                    <p className="text-gray-600 text-sm">CEO, Tech Company</p>
                  </div>
                </div>
              </div>
            ))}
